    ...
    <main className="firefox-scrollbar-margin-fix relative flex w-full h-full flex-col mt-4 overflow-hidden transition-[width,height]">
      ...
      {showScrollButton && (
        <button 
          ...
          className={`absolute bottom-[160px] left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium shadow-lg transition-colors ${theme === 'dark' ? 'bg-gray-800 text-white hover:bg-gray-700' : 'bg-white text-black hover:bg-gray-200'}`}
        >
