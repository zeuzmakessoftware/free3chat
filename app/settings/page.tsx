    ...
    >
        ...
        <div className="flex w-full">
            ...
            <main className={`w-[70%] h-full overflow-y-auto px-8 max-md:w-[100%]`}>
                ...
                <div className="my-4">
                    <p className="font-semibold my-4">What traits should Free3 Chat have? (up to 50, max 100 chars each)</p>
                ...
                <div className="my-4">
                    <p className="font-semibold my-4">Anything else Free3 Chat should know about you?</p>
